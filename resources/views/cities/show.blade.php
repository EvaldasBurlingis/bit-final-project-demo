                                ...
                                <div class="px-4 py-5 bg-white sm:p-6">
                                  <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-12">
                                      ...
                                      <input type="text" name="name" id="city_name" value={{ $city->name }} autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                    </div>
                                    ...
                                    <div class="col-span-12">
                                        ...
                                        <textarea id="country_description" class="ckeditor mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" name="description">{{ $city->description }}</textarea>
                                      </div>
